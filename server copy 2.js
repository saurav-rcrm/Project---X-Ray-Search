...
# Example
Input:
job_description: The ideal candidate must have 5+ years of experience with Python and JavaScript and understand Agile methodologies.
Output:
"\"software developer\" AND \"Python\" AND \"JavaScript\" AND \"Agile\" site:linkedin.com/in"

# Notes
- Tailor the query to include synonyms or alternative terms if applicable.`;
    ...
    // Use the serper.dev response as candidate data.
    let candidateData = serperResponse.data;
    if (!candidateData.organic || candidateData.organic.length === 0) {
      console.warn("No candidate details returned from serper.dev. Using fallback sample JSON.");
      candidateData = {
        candidates: [
          {
            name: "John Doe",
            ...
            skills: ["HTML", "TypeScript", "Vanilla CSS", "SCSS", "Vue.js", "React.js"]
          },
          {
            name: "Jane Smith",
            title: "Senior UI Developer",
            current_organization: "Another Tech Company",
